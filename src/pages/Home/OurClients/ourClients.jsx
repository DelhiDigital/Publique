  ...
  const partners = [
    {
      id: 1,
      name: "Company One",
      logo: "/assets/BrandsLogos/ambujaCement1.png?height=60&width=120",
    ...
    // },
    {
      id: 3,
      name: "Company Three",
      logo: "/assets/BrandsLogos/Reliance1.png?height=60&width=120",
      url: "https://example.com/3",
    },
    {
      id: 4,
      name: "Company Four",
      logo: "/assets/BrandsLogos/idfc1.png?height=60&width=120",
      url: "https://example.com/4",
    },
    {
      id: 5,
      name: "Company Five",
      logo: "/assets/BrandsLogos/sbilife1.png?height=60&width=120",
      url: "https://example.com/5",
    },
    {
      id: 6,
      name: "Company Six",
      logo: "/assets/BrandsLogos/tatamoter1.png?height=60&width=120",
      url: "https://example.com/6",
    },
    {
      id: 7,
      name: "Company Seven",
      logo: "/assets/BrandsLogos/tatacapital1.png?height=60&width=120",
      url: "https://example.com/7",
    },
    {
      id: 8,
      name: "Company Eight",
      logo: "/assets/BrandsLogos/adani1.png?height=60&width=120",
      url: "https://example.com/8",
    },
    {
      id: 9,
      name: "Company Nine",
      logo: "assets/BrandsLogos/bandhanBank1.png?height=60&width=120",
      url: "https://example.com/7",
    },
    {
      id: 10,
      name: "Company Ten",
      logo: "/assets/BrandsLogos/bdsomani1.png?height=60&width=120",
      url: "https://example.com/8",
    },
  ]
  ...
  const partners2 = [
    {
      id: 1,
      name: "Company One",
      logo: "/assets/BrandsLogos/chavara1.png?height=100&width=120",
      url: "https://example.com/1",
    },
    {
      id: 2,
      name: "Company Two",
      logo: "/assets/BrandsLogos/edelweiss1.png?height=60&width=120",
      url: "https://example.com/2",
    },
    {
      id: 3,
      name: "Company Three",
      logo: "/assets/BrandsLogos/ginger1.png?height=60&width=120",
      url: "https://example.com/3",
    },
    {
      id: 4,
      name: "Company Four",
      logo: "assets/BrandsLogos/hindustanElectric1.png?height=60&width=120",
      url: "https://example.com/4",
    },
    {
      id: 5,
      name: "Company Five",
      logo: "/assets/BrandsLogos/icici1.png?height=60&width=120",
      url: "https://example.com/5",
    },
    {
      id: 6,
      name: "Company Six",
      logo: "/assets/BrandsLogos/manipalglobal1.png?height=60&width=120",
      url: "https://example.com/6",
    },
    {
      id: 7,
      name: "Company Seven",
      logo: "/assets/BrandsLogos/marriott1.png?height=60&width=120",
      url: "https://example.com/7",
    },
    {
      id: 8,
      name: "Company Eight",
      logo: "/assets/BrandsLogos/neo1.png?height=60&width=120",
      url: "https://example.com/8",
    },
    {
      id: 9,
      name: "Company Nine",
      logo: "/assets/BrandsLogos/rbl1.png?height=60&width=120",
      url: "https://example.com/7",
    },
    {
      id: 10,
      name: "Company Ten",
      logo: "/assets/BrandsLogos/suryoday1.png?height=60&width=120",
      url: "https://example.com/8",
    },
  ]
      ...
      <div className="trustedClient_container">
        <div className="trustedClient_header">
          <div className="trustedClient_titleContainer">
            ...
            <h2 className="trustedClient_title">Awards and recognition</h2>
          </div>
